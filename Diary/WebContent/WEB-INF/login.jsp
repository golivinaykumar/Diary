...
<html lang="en">
  ...
  <body>
    ...
    <script src="<c:url value='/WebContent/WEB-INF/js/bootstrap-scrollspy.js'/>"></script>
    ...
    $("#signin").click(function(){
    	if($("#username").val()=="" || $("#password").val()==""){
    		...
    		document.getElementById("loginfrom").action="/home";
    	}
    ...
    $("#signin").click(function(){
    	document.getElementById("loginfrom").action="signup";
    });
